...
--nr peale DateOfBirth muutujat näitab et mismoodi kuvab DOB
...
select CEILING(15.2) -- TAGASTAB 16 JA suurendab suurema täisavu suunas
select CEILING(-15.2) --tagastab -15 ja suurenab suurema positiivse täisarvu suunas
